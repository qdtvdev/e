...
function App() {
  ...
  // Typewriter effect
  const [bioText, setBioText] = useState("1,100,000+ Network");
  ...
  return (
    <div className='app-container'>
      ...
      <div className={`main-container ${entered ? 'entered' : ''}`}>
        ...
        <div className='info' >
          <h1 className='name'> @qdtv</h1>
          <h1 className='bio'>{bio}</h1> {/* Bio with typewriter effect */}
        </div>
        <div className='links'>
          <a href="https://github.com/qdtvdev" target="_blank" rel="noopener noreferrer">
            <img src={git} className='link2' alt="GitHub" />
          </a>
          <a href="https://www.instagram.com/spxzz5ive/" target="_blank" rel="noopener noreferrer">
            <img src={insta} className='link3' alt="Instagram" />
          </a>
          <a href="https://discord.com/users/569203501901545483" target="_blank" rel="noopener noreferrer">
        ...
        <div className='song'>
          ...
          <div className='songinfo'>
            <p1 className='songtitle'>Wakeup</p1>
            <p1 className='artist'>Kankan </p1>
            <p1 className='album' href>on Wakeup</p1>
          </div>
